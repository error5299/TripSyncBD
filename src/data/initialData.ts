...
export const initialTourSettings: TourSettings = {
  ...
  tourDates: '১ সেপ্টেম্বর ২০২৬ (তারিখ পরিবর্তন হতে পারে)',
  departureTime: '১ সেপ্টেম্বর ২০২৬ (বিকাল/সন্ধ্যা যাত্রা)',
  totalSeats: 41,
  pricePerPerson: 2699,
...
export const initialAnnouncements: Announcement[] = [
  {
    ...
    message: 'যাত্রার সম্ভাব্য তারিখ ১ সেপ্টেম্বর (তারিখ পরিবর্তন হতে পারে)। সিট খালি থাকা সাপেক্ষে বুকিং চলবে। কোনো মৌখিক বুকিং গ্রহণযোগ্য নয়।',
    date: '২০২৬-০৮-২৫',
    priority: 'জরুরি'
  },
  {
...
export const tourTimeline: ItineraryDay[] = [
  {
    ...
    description: '১ সেপ্টেম্বর (তারিখ পরিবর্তন হতে পারে), আল্লারদর্গা - ভেড়ামারা - পাবনা - সিরাজগঞ্জ রুট হয়ে কুষ্টিয়া থেকে সুনামগঞ্জের উদ্দেশ্যে আমাদের সংরক্ষিত রিজার্ভ বাসে আরামদায়ক নাইট জার্নি শুরু।',
...
export const faqs = [
  ...
  },
  {
    ...
    a: 'যাত্রার রুট: আল্লারদর্গা - ভেড়ামারা - পাবনা - সিরাজগঞ্জ হয়ে সুনামগঞ্জ ও টাঙ্গুয়ার হাওর। সময়কাল: ২ রাত ১ দিন ডে ট্যুর। যাত্রার সম্ভাব্য তারিখ ১ সেপ্টেম্বর ২০২৬ (তারিখ পরিবর্তন হতে পারে)।'
  },
  {
