    ...
    <section id="gallery" className="py-24 sm:py-32 bg-slate-50 relative overflow-hidden">
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-semibold transition-all duration-300 ${
                selectedCategory === cat
                  ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-700/20 scale-105'
          ...
          {filteredPhotos.map((photo, index) => {
            ...
            return (
              <div
                ...
                className={`group relative rounded-3xl overflow-hidden shadow-md cursor-pointer border border-slate-200 bg-slate-900 ${
              ...
              >
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 rounded-full bg-slate-950/70 backdrop-blur-md text-emerald-300 text-xs font-semibold border border-white/10">
                    {photo.category}
                  </span>
                </div>
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white transform translate-y-1 group-hover:translate-y-0 transition-transform duration-300">
                  ...
                  <div className="flex items-center gap-1.5 text-[11px] text-emerald-300 mt-2 font-medium">
      ...
      {activePhoto && (
        <div className="fixed inset-0 z-50 bg-slate-950/95 backdrop-blur-xl flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-300">
          ...
          <div className="max-w-4xl w-full max-h-[90vh] flex flex-col rounded-3xl overflow-hidden bg-slate-900 border border-white/10 shadow-2xl">
            ...
            <div className="p-6 bg-slate-900 text-white flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-t border-white/10">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="px-2.5 py-0.5 rounded-full bg-emerald-600/50 text-emerald-200 text-xs font-semibold">
