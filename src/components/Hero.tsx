  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-950/90 via-slate-900/80 to-slate-900/40 sm:to-transparent pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-transparent to-slate-950/60 pointer-events-none" />
        <div className="absolute inset-0 bg-emerald-900/20 backdrop-blur-[0.5px] pointer-events-none" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-3 mb-6 sm:mb-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 text-xs sm:text-sm font-semibold backdrop-blur-md">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900/60 border border-white/20 text-slate-100 text-xs sm:text-sm font-medium backdrop-blur-md">
            <MapPin className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
            <span>
              রুট: <strong className="text-white font-bold">আল্লারদর্গা - ভেড়ামারা - পাবনা - সিরাজগঞ্জ</strong> ➔ <strong className="text-emerald-300 font-bold">টাঙ্গুয়ার হাওর</strong>
            </span>
          </div>

          <div className="hidden md:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-emerald-400/20 border border-emerald-400/30 text-emerald-200 text-xs font-bold backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 text-emerald-300 font-bold text-xs sm:text-sm uppercase tracking-wider bg-emerald-900/60 border border-emerald-500/30 px-3 py-1.5 rounded-lg backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 max-w-xl mx-auto lg:mx-0 text-left">
              ...
              {/* Box 1: Price */}
              <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900/60 hover:bg-slate-900/80 border border-emerald-500/30 shadow-lg backdrop-blur-md transition-all flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 flex items-center justify-center font-black text-lg shrink-0">
                  ৳
                </div>
                <div className="min-w-0">
                  ...
                  <div className="text-base sm:text-lg font-black text-white font-sans">
                    ...
                    <span className="text-xs font-medium text-emerald-300">টাকা</span>
                  </div>
                </div>
              </div>

              {/* Box 2: Seats Availability */}
              <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900/60 hover:bg-slate-900/80 border border-sky-500/30 shadow-lg backdrop-blur-md transition-all flex items-center gap-3">
              ...
              <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900/60 hover:bg-slate-900/80 border border-teal-500/30 shadow-lg backdrop-blur-md transition-all flex items-center gap-3">
              ...
              <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900/60 hover:bg-slate-900/80 border border-amber-500/30 shadow-lg backdrop-blur-md transition-all flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[10px] text-emerald-300 font-medium">৮টি প্রধান স্পট ভ্রমণ</div>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3.5 pt-2 max-w-xl mx-auto lg:mx-0">
              <button
                ...
                className="w-full sm:w-auto flex-1 px-8 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 via-emerald-600 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white text-base sm:text-lg font-black shadow-xl shadow-emerald-900/40 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2.5 group"
              >
              ...
              <a
                ...
                href="#package"
                className="w-full sm:w-auto px-6 py-4 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/30 text-white text-base font-bold shadow-sm backdrop-blur-md transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2 text-xs font-semibold text-slate-300">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <a href={`tel:${settings.organizerPhone}`} className="text-white hover:text-emerald-300 underline font-mono">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="relative rounded-3xl bg-slate-900/60 border border-white/15 p-6 sm:p-7 shadow-2xl backdrop-blur-xl text-white space-y-5">
              ...
              <div className="space-y-2.5">
                <div className="text-xs font-bold uppercase tracking-wider text-slate-400">ট্যুরের প্রধান আকর্ষণসমূহ:</div>
                <div className="grid grid-cols-2 gap-2 text-xs font-medium text-slate-200">
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-emerald-400">✦</span> ওয়াচ টাওয়ার
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-emerald-400">✦</span> নিলাদ্রি লেক
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-emerald-400">✦</span> টেকেরঘাট
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-emerald-400">✦</span> শিমুল বাগান
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-emerald-400">✦</span> বারিক্কা টিলা
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-emerald-400">✦</span> যাদুকাটা নদী
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-emerald-400">✦</span> সাদা পাথর
                  </div>
                  <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-emerald-400">✦</span> লাকমা ছড়া
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs">
                <span className="text-slate-300 flex items-center gap-1">
                  <span className="text-emerald-400 font-bold">✓</span> কুষ্টিয়া - সুনামগঞ্জ আপ-ডাউন বাস
                </span>
                <span className="font-bold text-emerald-300 bg-emerald-950/80 px-2.5 py-1 rounded-md border border-emerald-500/40">
                  ফি: মাত্র ২৬৯৯/- টাকা
                </span>
              </div>
