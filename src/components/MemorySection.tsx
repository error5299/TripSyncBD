  ...
  return (
    <section className="relative py-28 sm:py-36 overflow-hidden bg-slate-950 text-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-slate-950/80 via-amber-950/40 to-slate-950/80" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
          <div className="p-4 rounded-2xl bg-slate-900/60 backdrop-blur-md border border-amber-500/20">
          ...
          <div className="p-4 rounded-2xl bg-slate-900/60 backdrop-blur-md border border-amber-500/20">
            <Camera className="w-5 h-5 text-amber-400 mx-auto mb-2" />
