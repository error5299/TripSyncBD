...
export const EmotionalIntro: React.FC = () => {
  return (
    <section id="about" className="py-24 sm:py-32 bg-slate-50 relative overflow-hidden">
      {/* Subtle warm amber decorative gradient in background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-amber-100/90 text-amber-950 text-xs font-semibold tracking-wide border border-amber-300">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 leading-[1.25] tracking-tight font-sans">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-700 via-yellow-700 to-amber-900">
                মনে থেকে যায় আজীবন
              </span>
            </h2>
            ...
            <div className="pt-4 grid grid-cols-2 sm:grid-cols-3 gap-4 border-t border-slate-200">
              <div className="space-y-1">
                <span className="text-2xl font-bold text-amber-800 block font-sans">৮টি</span>
                <span className="text-xs text-slate-700 font-medium">আকর্ষণীয় দর্শনীয় স্থান</span>
              </div>
              <div className="space-y-1">
                <span className="text-2xl font-bold text-yellow-800 block font-sans">১০০%</span>
                <span className="text-xs text-slate-700 font-medium">নিরাপদ ও সুশৃঙ্খল</span>
              </div>
              <div className="space-y-1">
                <span className="text-2xl font-bold text-amber-900 block font-sans">২৬৯৯/-</span>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              {/* Decorative amber backdrop frame */}
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-tr from-amber-400 to-yellow-500 opacity-20 blur-xl transform -rotate-3" />
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-slate-200">
                ...
                <div className="absolute bottom-4 left-4 right-4 p-4 rounded-2xl bg-slate-950/85 backdrop-blur-md text-white border border-amber-400/20 shadow-lg">
              ...
              <div className="absolute -top-6 -right-4 sm:-right-6 bg-white p-3 sm:p-4 rounded-2xl shadow-xl border border-amber-200/80 flex items-center gap-3">
