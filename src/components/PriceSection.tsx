...
export const PriceSection: React.FC = () => {
  ...
  const packageHighlights = [
    'কুষ্টিয়া - নেত্রকোনা আপ-ডাউন বাস (আল্লারদর্গা-ভেড়ামারা-পাবনা-সিরাজগঞ্জ হয়ে)',
  ...
  return (
    <section id="pricing" className="py-24 sm:py-32 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white relative overflow-hidden scroll-mt-12">
      ...
      <div className="absolute -top-24 left-1/2 transform -translate-x-1/2 w-[700px] h-[350px] bg-emerald-500/15 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-10 w-96 h-96 bg-teal-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative rounded-3xl bg-slate-900/90 border border-emerald-500/30 p-8 sm:p-12 shadow-2xl backdrop-blur-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 text-center lg:text-left space-y-5 lg:border-r lg:border-slate-800 lg:pr-8">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-emerald-600/20 text-emerald-300 text-xs font-semibold border border-emerald-500/30">
              ...
              <div>
                ...
                <div className="flex items-baseline justify-center lg:justify-start gap-2">
                  ...
                  <span className="text-xl text-emerald-400 font-medium font-sans">টাকা</span>
                </div>
                <span className="text-emerald-400 text-sm font-semibold mt-1 block">
                  বাস + বোট + ২ বেলা খাবার সহ
                </span>
              </div>

              <div className="p-4 rounded-2xl bg-slate-800/80 border border-emerald-500/20 text-xs text-slate-300 space-y-1.5 text-left">
                <div className="flex items-center justify-between text-slate-200 font-medium">
                  <span>খালি আসন সংখ্যা:</span>
                  <span className="text-emerald-400 font-bold text-sm">{stats.availableSeats}টি</span>
                </div>
              ...
              <button
                ...
                className="w-full py-4 px-6 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-500 hover:to-teal-600 text-white font-bold text-base sm:text-lg shadow-lg shadow-emerald-700/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-3 group"
              >
